...
new_name = ['JetBlue Airways',
'PSA Airlines', 'Endeavor Air', 'Southwest Airlines', 'United Airlines', 'American Airlines', 'SkyWest Airlines','Midwest Airlines','Delta Air Lines','Envoy Air']
